...
!define INSTALLATION_LAYOUT_REGISTRY_KEY "Software\AngelaBox\desktop"
...
!macro customHeader
  ...
  LangString migratingExistingData ${LANG_ENGLISH} "Migrating existing AngelaBox data..."
  LangString migratingExistingData ${LANG_SIMPCHINESE} "正在迁移现有 AngelaBox 数据..."
  LangString migratingExistingData ${LANG_TRADCHINESE} "正在遷移現有 AngelaBox 資料..."
  LangString migratingExistingData ${LANG_FARSI} "در حال انتقال داده‌های موجود AngelaBox..."
  LangString migratingExistingData ${LANG_RUSSIAN} "Перенос существующих данных AngelaBox..."
  ...
  LangString stoppingService ${LANG_ENGLISH} "Stopping the AngelaBox service..."
  LangString stoppingService ${LANG_SIMPCHINESE} "正在停止 AngelaBox 守护进程..."
  LangString stoppingService ${LANG_TRADCHINESE} "正在停止 AngelaBox 守護程序..."
  LangString stoppingService ${LANG_FARSI} "در حال توقف سرویس AngelaBox..."
  LangString stoppingService ${LANG_RUSSIAN} "Остановка службы AngelaBox..."

  LangString checkingRunningApplication ${LANG_ENGLISH} "Checking for running AngelaBox applications..."
  LangString checkingRunningApplication ${LANG_SIMPCHINESE} "正在检查运行中的 AngelaBox 应用..."
  LangString checkingRunningApplication ${LANG_TRADCHINESE} "正在檢查執行中的 AngelaBox 應用程式..."
  LangString checkingRunningApplication ${LANG_FARSI} "در حال بررسی برنامه‌های در حال اجرای AngelaBox..."
  LangString checkingRunningApplication ${LANG_RUSSIAN} "Проверка запущенных приложений AngelaBox..."

  LangString closingApplication ${LANG_ENGLISH} "Closing AngelaBox..."
  LangString closingApplication ${LANG_SIMPCHINESE} "正在关闭 AngelaBox 应用..."
  LangString closingApplication ${LANG_TRADCHINESE} "正在關閉 AngelaBox 應用程式..."
  LangString closingApplication ${LANG_FARSI} "در حال بستن AngelaBox..."
  LangString closingApplication ${LANG_RUSSIAN} "Закрытие AngelaBox..."
  ...
  LangString stopServiceFailed ${LANG_ENGLISH} "Failed to stop the AngelaBox service."
  LangString stopServiceFailed ${LANG_SIMPCHINESE} "无法停止 AngelaBox 守护进程。"
  LangString stopServiceFailed ${LANG_TRADCHINESE} "無法停止 AngelaBox 守護程序。"
  LangString stopServiceFailed ${LANG_FARSI} "توقف سرویس AngelaBox ناموفق بود."
  LangString stopServiceFailed ${LANG_RUSSIAN} "Не удалось остановить службу AngelaBox."
  ...
  LangString registeringService ${LANG_ENGLISH} "Registering the AngelaBox service..."
  LangString registeringService ${LANG_SIMPCHINESE} "正在注册 AngelaBox 守护进程..."
  LangString registeringService ${LANG_TRADCHINESE} "正在註冊 AngelaBox 守護程序..."
  LangString registeringService ${LANG_FARSI} "در حال ثبت سرویس AngelaBox..."
  LangString registeringService ${LANG_RUSSIAN} "Регистрация службы AngelaBox..."

  LangString registerServiceFailed ${LANG_ENGLISH} "Failed to register the AngelaBox service (code $1)."
  LangString registerServiceFailed ${LANG_SIMPCHINESE} "无法注册 AngelaBox 守护进程（代码 $1）。"
  LangString registerServiceFailed ${LANG_TRADCHINESE} "無法註冊 AngelaBox 守護程序（代碼 $1）。"
  LangString registerServiceFailed ${LANG_FARSI} "ثبت سرویس AngelaBox ناموفق بود (کد $1)."
  LangString registerServiceFailed ${LANG_RUSSIAN} "Не удалось зарегистрировать службу AngelaBox (код $1)."
  ...
  LangString copyingApplicationFiles ${LANG_ENGLISH} "Copying AngelaBox application files..."
  LangString copyingApplicationFiles ${LANG_SIMPCHINESE} "正在复制 AngelaBox 应用程序文件..."
  LangString copyingApplicationFiles ${LANG_TRADCHINESE} "正在複製 AngelaBox 應用程式檔案..."
  LangString copyingApplicationFiles ${LANG_FARSI} "در حال کپی فایل‌های برنامهٔ AngelaBox..."
  LangString copyingApplicationFiles ${LANG_RUSSIAN} "Копирование файлов приложения AngelaBox..."
  ...
  LangString registerServiceFailedRolledBack ${LANG_ENGLISH} "Failed to register the AngelaBox service (code $1). The installed application was removed.$\r$\n$\r$\n$3"
  LangString registerServiceFailedRolledBack ${LANG_SIMPCHINESE} "无法注册 AngelaBox 守护进程（代码 $1）。已移除安装的应用程序。$\r$\n$\r$\n$3"
  LangString registerServiceFailedRolledBack ${LANG_TRADCHINESE} "無法註冊 AngelaBox 守護程序（代碼 $1）。已移除安裝的應用程式。$\r$\n$\r$\n$3"
  LangString registerServiceFailedRolledBack ${LANG_FARSI} "ثبت سرویس AngelaBox ناموفق بود (کد $1). برنامهٔ نصب‌شده حذف شد.$\r$\n$\r$\n$3"
  LangString registerServiceFailedRolledBack ${LANG_RUSSIAN} "Не удалось зарегистрировать службу AngelaBox (код $1). Установленное приложение удалено.$\r$\n$\r$\n$3"

  LangString registerServiceFailedRollbackFailed ${LANG_ENGLISH} "Failed to register the AngelaBox service (code $1), and automatic removal failed (code $2).$\r$\n$\r$\n$3"
  LangString registerServiceFailedRollbackFailed ${LANG_SIMPCHINESE} "无法注册 AngelaBox 守护进程（代码 $1），且自动移除失败（代码 $2）。$\r$\n$\r$\n$3"
  LangString registerServiceFailedRollbackFailed ${LANG_TRADCHINESE} "無法註冊 AngelaBox 守護程序（代碼 $1），且自動移除失敗（代碼 $2）。$\r$\n$\r$\n$3"
  LangString registerServiceFailedRollbackFailed ${LANG_FARSI} "ثبت سرویس AngelaBox ناموفق بود (کد $1) و حذف خودکار نیز ناموفق بود (کد $2).$\r$\n$\r$\n$3"
  LangString registerServiceFailedRollbackFailed ${LANG_RUSSIAN} "Не удалось зарегистрировать службу AngelaBox (код $1), а автоматическое удаление завершилось ошибкой (код $2).$\r$\n$\r$\n$3"
  ...
  LangString unsafeInstallationConfirmationWarning ${LANG_ENGLISH} "The installer and service will skip path security checks and permission hardening. This can allow another program to replace AngelaBox data or binaries and elevate privileges to SYSTEM."
  LangString unsafeInstallationConfirmationWarning ${LANG_SIMPCHINESE} "安装程序和守护进程将跳过路径安全检查与权限加固。这可能允许其他程序替换 AngelaBox 数据或程序文件并提权到 SYSTEM。"
  LangString unsafeInstallationConfirmationWarning ${LANG_TRADCHINESE} "安裝程式和守護程序將略過路徑安全檢查與權限強化。這可能允許其他程式取代 AngelaBox 資料或程式檔案並將權限提升至 SYSTEM。"
  LangString unsafeInstallationConfirmationWarning ${LANG_FARSI} "نصب‌کننده و سرویس، بررسی امنیت مسیر و ایمن‌سازی مجوزها را نادیده می‌گیرند. این کار ممکن است به برنامه‌ای دیگر اجازه دهد داده‌ها یا فایل‌های AngelaBox را جایگزین کند و سطح دسترسی را به SYSTEM برساند."
  LangString unsafeInstallationConfirmationWarning ${LANG_RUSSIAN} "Установщик и служба пропустят проверку безопасности путей и усиление разрешений. Другая программа сможет подменить данные или файлы AngelaBox и повысить привилегии до SYSTEM."
  ...
  !ifndef BUILD_UNINSTALLER
  LangString resetWorkingDirectoryPrompt ${LANG_ENGLISH} "The AngelaBox service data directory is invalid:$\r$\n$workingDirectory$\r$\nContinuing will delete this directory so the service can recreate it securely. Continue?"
  LangString resetWorkingDirectoryPrompt ${LANG_SIMPCHINESE} "AngelaBox 守护进程数据目录无效：$\r$\n$workingDirectory$\r$\n继续安装将删除此目录，以便守护进程用安全权限重新创建。是否继续？"
  LangString resetWorkingDirectoryPrompt ${LANG_TRADCHINESE} "AngelaBox 守護程序資料目錄無效：$\r$\n$workingDirectory$\r$\n繼續安裝將刪除此目錄，以便守護程序用安全權限重新建立。是否繼續？"
  LangString resetWorkingDirectoryPrompt ${LANG_FARSI} "پوشهٔ دادهٔ سرویس AngelaBox نامعتبر است:$\r$\n$workingDirectory$\r$\nبا ادامه، این پوشه حذف می‌شود تا سرویس آن را با مجوزهای امن دوباره ایجاد کند. ادامه می‌دهید؟"
  LangString resetWorkingDirectoryPrompt ${LANG_RUSSIAN} "Каталог данных службы AngelaBox недействителен:$\r$\n$workingDirectory$\r$\nПри продолжении каталог будет удалён, чтобы служба могла безопасно создать его заново. Продолжить?"

  LangString resettingWorkingDirectory ${LANG_ENGLISH} "Resetting the AngelaBox service data directory..."
  LangString resettingWorkingDirectory ${LANG_SIMPCHINESE} "正在重置 AngelaBox 守护进程数据目录..."
  LangString resettingWorkingDirectory ${LANG_TRADCHINESE} "正在重設 AngelaBox 守護程序資料目錄..."
  LangString resettingWorkingDirectory ${LANG_FARSI} "در حال بازنشانی پوشهٔ دادهٔ سرویس AngelaBox..."
  LangString resettingWorkingDirectory ${LANG_RUSSIAN} "Сброс каталога данных службы AngelaBox..."

  LangString resetWorkingDirectoryFailed ${LANG_ENGLISH} "Could not reset the AngelaBox service data directory (code $1). No application files were installed."
  LangString resetWorkingDirectoryFailed ${LANG_SIMPCHINESE} "无法重置 AngelaBox 守护进程数据目录（代码 $1）。尚未安装任何应用程序文件。"
  LangString resetWorkingDirectoryFailed ${LANG_TRADCHINESE} "無法重設 AngelaBox 守護程序資料目錄（代碼 $1）。尚未安裝任何應用程式檔案。"
  LangString resetWorkingDirectoryFailed ${LANG_FARSI} "بازنشانی پوشهٔ دادهٔ سرویس AngelaBox ممکن نشد (کد $1). هیچ فایل برنامه‌ای نصب نشد."
  LangString resetWorkingDirectoryFailed ${LANG_RUSSIAN} "Не удалось сбросить каталог данных службы AngelaBox (код $1). Файлы приложения ещё не устанавливались."
  !endif
  ...
  LangString removingService ${LANG_ENGLISH} "Removing the AngelaBox service..."
  LangString removingService ${LANG_SIMPCHINESE} "正在移除 AngelaBox 守护进程..."
  LangString removingService ${LANG_TRADCHINESE} "正在移除 AngelaBox 守護程序..."
  LangString removingService ${LANG_FARSI} "در حال حذف سرویس AngelaBox..."
  LangString removingService ${LANG_RUSSIAN} "Удаление службы AngelaBox..."

  LangString removeServiceFailed ${LANG_ENGLISH} "Failed to remove the AngelaBox service (code $1).$\r$\n$\r$\n$3"
  LangString removeServiceFailed ${LANG_SIMPCHINESE} "无法移除 AngelaBox 守护进程（代码 $1）。$\r$\n$\r$\n$3"
  LangString removeServiceFailed ${LANG_TRADCHINESE} "無法移除 AngelaBox 守護程序（代碼 $1）。$\r$\n$\r$\n$3"
  LangString removeServiceFailed ${LANG_FARSI} "حذف سرویس AngelaBox ناموفق بود (کد $1).$\r$\n$\r$\n$3"
  LangString removeServiceFailed ${LANG_RUSSIAN} "Не удалось удалить службу AngelaBox (код $1).$\r$\n$\r$\n$3"

  LangString removingData ${LANG_ENGLISH} "Removing AngelaBox data..."
  LangString removingData ${LANG_SIMPCHINESE} "正在移除 AngelaBox 数据..."
  LangString removingData ${LANG_TRADCHINESE} "正在移除 AngelaBox 資料..."
  LangString removingData ${LANG_FARSI} "در حال حذف داده‌های AngelaBox..."
  LangString removingData ${LANG_RUSSIAN} "Удаление данных AngelaBox..."
!macroend
...
!macro customInit
  ...
  StrCpy $daemonDataDirectory "$APPDATA\angelabox-daemon"
  StrCpy $0 0
  ...
  ${if} $hasExistingInstallation == 0
    ${if} $applicationDataDirectory == ""
      StrCpy $applicationDataDirectory "$APPDATA\AngelaBox"
    ${endif}
    ${GetParameters} $R0
    ClearErrors
  ...
  ${endif}
  ${if} $applicationDataDirectory == ""
    StrCpy $fixedApplicationDataDirectory "$APPDATA\AngelaBox"
  ...
  StrCpy $userApplicationDataDirectory "$APPDATA\AngelaBox"
  SetShellVarContext all
  ...
  StrCpy $dataTransitionStatePath "$APPDATA\AngelaBox-installer\data-transition.json"
  InitPluginsDir
...
!macro customInstallBeforeInstallationChanges
  ...
  nsExec::ExecToLog '"$SYSDIR\WindowsPowerShell\v1.0\powershell.exe" -NoProfile -NonInteractive -Command "if (Get-Service -Name angelabox-daemon -ErrorAction SilentlyContinue) { Stop-Service -Name angelabox-daemon -Force -ErrorAction Stop; (Get-Service -Name angelabox-daemon).WaitForStatus([System.ServiceProcess.ServiceControllerStatus]::Stopped, [TimeSpan]::FromSeconds(10)) }"'
  Pop $1
  ${if} $1 != 0
