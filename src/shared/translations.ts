...
export const DESKTOP_TRANSLATIONS = {
  ...
  "The sing-box service is not installed": {
    "zh-Hans": "AngelaBox 服务未安装",
    "zh-Hant": "AngelaBox 服務未安裝",
    "fa": "سرویس AngelaBox نصب نشده است",
    "ru": "Служба AngelaBox не установлена",
  },
  "The sing-box service is not running": {
    "zh-Hans": "AngelaBox 服务未运行",
    "zh-Hant": "AngelaBox 服務未運行",
    "fa": "سرویس AngelaBox در حال اجرا نیست",
    "ru": "Служба AngelaBox не запущена",
  },
